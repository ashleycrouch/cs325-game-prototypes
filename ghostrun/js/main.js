...
window.onload = function() {
    ...
    // function preload() {
    //     game.load.image('test', 'assets/tempghost.jpg');
    ...
    //     game.create.texture('test', ghost, pixelWidth, pixelHeight);
    //     //game.create.texture('ground', ground, pixelWidth, pixelHeight);
    //     game.add.sprite(game.world.centerX, game.world.centerY, 'test');
